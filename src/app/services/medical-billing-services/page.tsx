...
export const metadata: Metadata = buildPageMetadata({
  title: "Medical Billing Services - RCM, Claims & HIPAA-Compliant Billing",
  description:
    "End-to-end medical billing services: hospital and physician billing, credentialing, audits, denial management, and HIPAA-compliant revenue cycle workflows powered by intelligent technology.",
  path: PATH,
  keywords: [
    ...
    <>
      ...
      <div>
        ...
        <ServiceFaqs
          ...
          items={faqItems}
          sectionClassName="bg-white px-4 py-16 sm:px-6 md:py-24"
          hideHeadingAccent
        />
        <MedicalBillingCta />
      </div>
