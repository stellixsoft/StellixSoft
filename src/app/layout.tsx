  ...
  return (
    <html lang="en">
      ...
      <body className={`${poppins.variable} font-sans antialiased`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[9999] focus:px-4 focus:py-2 focus:bg-[var(--color-electricBlue)] focus:text-white focus:rounded-lg focus:text-sm focus:font-medium"
        >
