 ...
 */
export const STATIC_HUB_LAST_MOD = new Date("2026-04-07T12:00:00.000Z");
export const STATIC_SERVICES_HUB_LAST_MOD = new Date("2026-04-07T12:00:00.000Z");
export const STATIC_SERVICE_PAGE_LAST_MOD = new Date("2026-04-07T12:00:00.000Z");
