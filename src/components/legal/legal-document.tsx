...
type LegalDocumentProps = {
  ...
  lastUpdated: string;
  children: ReactNode;
  /** When true, skip the built-in dark header (use a page-level video hero instead). */
  hideHeader?: boolean;
};
  ...
  return (
    <div>
      ...
      <div className="px-6 py-12 md:py-16 bg-gradient-to-b from-slate-50/80 to-white">
        <article className="max-w-[1200px] mx-auto rounded-2xl border border-slate-200/90 bg-white p-8 md:p-12 shadow-sm">
