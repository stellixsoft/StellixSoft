export default function InterpriseSoftware() {
    return (
        <section
        ...
        >
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-medium text-[var(--color-deepSpace)] mb-6">Custom Enterprise Software Development Services for {" "}
                  <span
