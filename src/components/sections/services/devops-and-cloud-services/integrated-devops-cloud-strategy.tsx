...
export default function IntegratedDevOpsCloudStrategy() {
  return (
    <section
    ...
    >
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-sm md:text-[15px] text-slate-600 leading-relaxed mb-6">
          We combine DevOps and Cloud Services to create a unified infrastructure strategy that
          supports continuous delivery and scalability.
        </p>
        <p className="max-w-2xl mx-auto text-sm md:text-[15px] text-slate-600 leading-relaxed mb-6">
        ...
        <div className="max-w-3xl mx-auto w-full text-left">
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1.5 text-sm md:text-[15px] text-slate-700 mb-12 list-none p-0 m-0">
            {integrationOutcomes.map((item) => (
