const trustPoints = [
    ...
    },
    {
      ...
      description:
        "Our software serves Fortune 500 companies. We build for scale, security, and reliability from day one.",
      icon: "partnership",
    },
    {
      title: "Long-Term Partnerships",
      description:
        "We don’t build and leave. Our average client relationship is 3+ years. We evolve with your product line.",
      icon: "globe",
    },
    {
      title: "US Timezone Alignment",
      description:
        "Real-time collaboration with your team. Your morning standup is our morning standup.",
      icon: "check",
    },
  ];
  ...
  export default function IoTSoftwarePartner() {
    return (
      <section className="py-16 md:py-24 px-4 sm:px-6 bg-white" style={{
        ...
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-[var(--color-deepSpace)] text-center">
            Why Hardware Companies Partner With Us
          </h2>
