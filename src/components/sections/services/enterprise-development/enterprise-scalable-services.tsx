...
export default function EnterpriseScalableServices() {
  return (
    <section
    ...
    >
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-sm md:text-[15px] text-slate-600 leading-relaxed mb-12">
          Our custom enterprise software development services are built for scalability and
          flexibility. Whether you&apos;re expanding operations or adding new features, our systems
