...
export default function DedicatedDevelopmentTeamModelIntro() {
  return (
    <section
    ...
    >
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-sm md:text-[15px] text-slate-600 leading-relaxed mb-6">
          ...
          goals, processes, and timelines. When you hire a dedicated development team, you eliminate
          hiring delays and gain a team that is fully focused on your product.
        </p>
        <p className="max-w-2xl mx-auto text-sm md:text-[15px] text-slate-600 leading-relaxed mb-6">
