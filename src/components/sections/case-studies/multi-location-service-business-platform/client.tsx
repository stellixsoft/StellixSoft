export default function MultiLocationServiceBusinessPlatformClient() {
  return (
    <section className="py-20 md:py-28 px-4 sm:px-6 bg-[#f5f7fb]">
      <div className="max-w-[1100px] mx-auto text-center">
        ...
        <p className="mt-3 text-sm md:text-base text-[var(--color-neutralGray)] leading-relaxed max-w-3xl mx-auto">
          Their challenge: Scale the business across geographies without the chaos of disconnected
          systems and inconsistent processes at each location.
        </p>
      </div>
    </section>
  );
