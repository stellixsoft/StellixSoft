const techStack = ["React", "Node.js", "Flutter", "PostgreSQL", "GCP"];

export default function MultiLocationServiceBusinessPlatformProjectOverview() {
  return (
      ...
      >
        ...
        <div className="relative flex flex-col justify-center text-[var(--color-deepSpace)]">
          ...
          <div className="md:pl-8">
            <p className="text-[10px] font-medium uppercase tracking-[0.1em] text-[var(--color-neutralGray)] mb-3">
              Team &amp; Duration
            </p>
            <ul className="space-y-3 text-sm md:text-[15px]">
              <li className="flex items-center gap-2.5">
                ...
                <span className="font-medium">5 months development</span>
              </li>
              <li className="flex items-center gap-2.5">
                <svg className="h-4 w-4 shrink-0 text-[var(--color-electricBlue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
